...
async.series([
	...
	typeString( 'u' ),
	typeString( 'p' ),
	downloadDocs( CURRENT_DOC_INDEX=0 ),
	move( 435, 158 ),
	clickMouse,
	hitDelete( 9 ),
	typeString( 'f' ),
	...
	typeString( 'u' ),
	typeString( 'p' ),
	downloadDocs( CURRENT_DOC_INDEX ),
	moveFiles( SAVE_PATH, '3299', CURRENT_DOC_INDEX ),
	move( 35, 56 ),
	clickMouse,
	clickMouse,
	clickMouse
